export default function Footer() {
  return (
    <>
      <footer className="px-4 pb-10 md:px-8 lg:px-12">
        <div
          aria-hidden="true"
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              <h2 className="bg-linear-to-b from-white/95 via-white/85 to-white/75 bg-clip-text bg-transparent text-2xl font-bold leading-tight tracking-tighter text-transparent [text-shadow:_0_4px_24px_rgba(255,255,255,0.2)]">
                HeroicBypass
                <span className="text-primary [text-shadow:_0_4px_24px_hsl(var(--primary)/0.45)]">
                  .XYZ
                </span>
              </h2>
              <p className="max-w-sm text-sm leading-6 text-muted-foreground">
                The Premium Cheating Experience
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-border/60 bg-card/40 text-muted-foreground transition-all hover:border-primary/40 hover:bg-primary/[0.06] hover:text-foreground"
              >
                <svg
                  width="15"
                  height="15"
              ...
              <span aria-hidden="true" className="h-6 w-px bg-border/60"></span>
            </div>
          </div>
